...
export function MyResults({ session }: MyResultsProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-gray-900">Keputusan Saya</h2>
        <p className="text-gray-600">
          Lihat markah penilaian dan maklum balas guru anda
        </p>
      </div>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-gray-600">Markah Purata</p>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-gray-600">Dengan Maklum Balas</p>
        ...
        <Card>
          <CardContent className="py-12">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Anda belum melengkapkan sebarang penilaian lagi
              </p>
              <p className="text-sm text-gray-500 mt-2">
                Pergi ke tab Amalan untuk mula mengambil penilaian
              </p>
            </div>
          </CardContent>
        </Card>
                      ...
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        {submission.feedback && (
                          <Badge variant="secondary" className="gap-1">
                            ...
                            Maklum Balas Tersedia
                          </Badge>
                        )}
                      </div>
                      <CardDescription>
                        {submission.assessmentCategory} • Diserahkan {formatDate(submission.submittedAt)}
                      </CardDescription>
                    </div>
                  ...
                  <CardContent>
                    <div className="bg-indigo-50 p-4 rounded-lg space-y-3">
                      <div className="flex items-center gap-2">
                        ...
                        <h4 className="text-indigo-900">Maklum Balas Guru</h4>
                      </div>
                      
                      {submission.manualScore !== undefined && submission.manualScore !== submission.score && (
                        <div className="bg-white dark:bg-gray-800 p-3 rounded border border-indigo-200 dark:border-indigo-900">
                          <p className="text-sm text-gray-600">
                            Markah anda telah diselaraskan daripada {submission.score} kepada {submission.manualScore} oleh guru anda
                          </p>
                        </div>
                      )}
                      ...
                      {submission.feedbackProvidedByName && submission.feedbackProvidedAt && (
                        <p className="text-xs text-gray-500 pt-2 border-t border-indigo-200">
                          Maklum balas oleh {submission.feedbackProvidedByName} pada {formatDate(submission.feedbackProvidedAt)}
                        </p>
                      )}
                    </div>
                  </CardContent>

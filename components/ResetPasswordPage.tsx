          ...
          <CardContent>
            ...
            {linkStatus === 'checking' && (
              <div className="mb-4 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg flex items-center gap-2">
                ...
                <p className="text-sm text-blue-700 dark:text-blue-300">Verifying reset link...</p>
              </div>
            )}
            ...
            {linkStatus === 'valid' && (
              <div className="mb-4 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg flex items-center gap-2">
                ...
                <p className="text-sm text-green-700 dark:text-green-300">Reset link verified! You can now set a new password.</p>
              </div>
            )}
              ...
              <div className="mb-4 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1">
                    <p className="text-sm text-red-700 dark:text-red-300 font-semibold mb-1">Invalid or Expired Link</p>

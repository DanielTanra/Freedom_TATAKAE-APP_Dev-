            ...
            <div className="border-2 border-indigo-100 rounded-xl p-4 space-y-2 max-h-64 overflow-y-auto bg-gradient-to-br from-gray-50 to-indigo-50/30">
              {classes.length === 0 ? (
                ...
                classes.map((cls) => (
                  <div 
                    key={cls.id} 
                    className="flex items-center space-x-3 p-3 rounded-lg hover:bg-white/60 dark:hover:bg-gray-700/60 transition-colors"
                  >
                    <Checkbox
                      id={`class-${cls.id}`}
                ...
                <div className="space-y-3">
                  {comparisonData
                    ...
                    .map((cls) => (
                      <div
                        key={cls.class_id}
                        className="flex items-center justify-between bg-white dark:bg-gray-800 p-4 rounded-xl border-2 border-orange-200 dark:border-orange-900 shadow-sm hover:shadow-md transition-shadow"
                      >

...
const SAMBANOVA_API_KEY = "33674654-2959-42d0-871f-87cccc35086f";
...
export function AIChat() {
  const [messages, setMessages] = useState<RatedMessage[]>([
    {
      role: "assistant",
      content:
        "Helo! Saya adalah tutor HCI anda yang dikuasakan oleh SambaNova. Saya boleh membantu anda memahami konsep Interaksi Manusia-Komputer, menjawab soalan anda, dan memberikan cadangan pembelajaran. Apa yang anda ingin belajar hari ini?",
    },
  ]);
  ...
  const suggestedQuestions = [
    "Apakah prinsip utama HCI?",
    "Terangkan reka bentuk berpusatkan pengguna",
  ...
  return (
    <div className="mt-1 h-7 relative">
      ...
      {showThankYou && (
        ...
        >
          <p className="text-sm text-indigo-600 italic">Terima kasih kerana memberi penilaian! ✨</p>
        </div>
      )}
    </div>
  );
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-3xl text-gray-900 dark:text-white">Tutor AI</h2>
        <p className="text-gray-600 dark:text-gray-400">Dapatkan bantuan segera dan cadangan pembelajaran yang diperibadikan</p>
      </div>
        ...
        <Card className="border-orange-200 bg-orange-50 dark:border-orange-800 dark:bg-orange-950">
          <CardContent className="py-4 flex gap-3">
            ...
            <p className="text-sm dark:text-gray-200">
              <strong>Kunci API SambaNova Hilang:</strong>  
              Tambahkan kunci anda di bahagian atas <code>AIChat.tsx</code>.
            </p>
          </CardContent>
        </Card>
      )}
      ...
      <Card className="h-[600px] flex flex-col dark:bg-gray-800 dark:border-gray-700">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <Bot className="w-5 h-5" /> Pembantu Pembelajaran HCI
          </CardTitle>
        </CardHeader>
        ...
        <CardContent className="flex-1 flex flex-col p-0">
              ...
              {messages.map((msg, idx) => (
                <div key={idx}>
                  ...
                  >
                    ...
                    {msg.role === "user" && (
                      <div className="bg-indigo-600 dark:bg-indigo-700 p-2 rounded-full">
          ...
          {messages.length === 1 && (
            <div className="p-4 border-t dark:border-gray-700">
              <p className="text-xs text-gray-600 dark:text-gray-400 mb-2">Cuba tanya:</p>
          ...
          <div className="p-4 border-t dark:border-gray-700 flex gap-2">
            <Input
              placeholder="Tanya saya apa-apa tentang HCI..."
              value={input}
